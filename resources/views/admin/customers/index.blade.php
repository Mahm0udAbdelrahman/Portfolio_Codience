                        ...
                        <div class="card-body">
                            <form method="GET" action="{{ route('Admin.customers.index') }}" class="mb-4"
                                ...
                                <div class="row g-3 justify-content-start text-start">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <label
                                            class="form-label fw-bold text-secondary">{{ __('Interest Status') }}</label>
                                        <select name="status" id="status-filter" class="form-select shadow-sm">
                                            ...
                                            <option value="neutral"
                                                {{ request('status') == 'neutral' ? 'selected' : '' }}>
                                                {{ __('Neutral') }}</option>
                            ...
                            <div class="table-responsive text-center">
                                <div id="customers-table-wrapper" style="position: relative;">
                                    <div id="loading-overlay" class="d-none justify-content-center align-items-center"
                                        style="position: absolute; top:0; left:0; right:0; bottom:0; background: rgba(255,255,255,0.7); z-index: 10; border-radius: 8px;">
                                    ...
                                    <table id="example2" class="table table-striped table-bordered align-middle">
                                        ...
                                        <tbody>
                                            @forelse($data as $customer)
                                                ...
                                                @elseif($customer->status == 'neutral') table-warning @endif
                                            ">
                                                    <td>{{ $loop->index + 1 }}</td>
                                                    <td>{{ $customer->name }}</td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        ...
                                                        @else
                                                            <span
                                                                class="badge bg-warning text-dark">{{ __('Neutral') }}</span>
                                                        @endif
                                                    </td>
                                                    <td>
                                                        <div class="d-flex justify-content-center align-items-center gap-1">
                                                            <button type="button"
                                                                class="btn btn-danger delete-country-btn"
                                                                data-id="{{ $customer->id }}"
                                                                title="{{ __('Delete') }}">
