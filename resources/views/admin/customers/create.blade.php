                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="status" class="form-select">
                                            <option value="neutral" {{ old('status') == 'neutral' ? 'selected' : '' }}>{{ __('Neutral') }}</option>
                                            <option value="interested" {{ old('status') == 'interested' ? 'selected' : '' }}>{{ __('Interested') }}</option>
                                            <option value="not_interested" {{ old('status') == 'not_interested' ? 'selected' : '' }}>{{ __('Not Interested') }}</option>
                                        </select>
