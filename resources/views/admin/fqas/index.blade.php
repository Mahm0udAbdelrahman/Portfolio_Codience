                ...
                <div class="col-12 col-xl-12">
                    <div class="card">
                        <div class="add d-flex justify-content-end p-2">
                            ...
                            <a href="{{ route('Admin.fqas.create') }}" class="btn btn-primary"> <i class="fas fa-add"></i>
                                {{ __('Add FQA') }}</a>
                                    ...
                                    <tbody>
                                        @forelse($data as $fqa)
                                            <tr>
                                                ...
                                                <td>{{ $fqa->{'question_' . app()->getLocale()} }}</td>
                                                <td>{{ $fqa->{'answer_' . app()->getLocale()} }}</td>
                                                <td>{{ $fqa->status }}</td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('Admin.fqas.edit', $fqa) }}"
