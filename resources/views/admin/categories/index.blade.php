                        ...
                        <div class="table-responsive text-center">
                            <table id="example2" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $loop->index + 1 }}</td>
                                        <td><img src="{{ asset('storage/categories/' . $category->logo) }}" alt="logo" style="max-width: 80px;"></td>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-danger w-25 delete-country-btn" data-id="{{ $category->id }}">
                                                <i class="far fa-trash-alt"></i>
                                            </button>

                                            <a href="{{ route('Admin.categories.edit',$category) }}" class="btn btn-info w-25"><i class="fas fa-edit"></i></a>
