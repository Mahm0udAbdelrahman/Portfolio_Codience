                ...
                <div class="col-12 col-xl-12">
                    <div class="card">
                        <div class="add d-flex justify-content-end p-2">
                            ...
                            <a href="{{ route('Admin.how_we_works.create') }}" class="btn btn-primary"> <i
                                    class="fas fa-add"></i> {{ __('Add How We Work') }}</a>
                                ...
                                <table id="example2" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        @forelse($data as $how_we_work)
                                            <tr>
                                                <td>{{ $loop->index + 1 }}</td>
                                                <td><img src="{{ asset('storage/how_we_works/' . $how_we_work->logo) }}"
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('Admin.how_we_works.edit', $how_we_work) }}"
                ...
                button.addEventListener('click', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            form.action = '{{ url('/admin/how_we_works') }}/' + id;
                            form.method = 'POST';
